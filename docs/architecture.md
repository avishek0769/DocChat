...
1. **System Prompt**: Declares the assistant's persona, commands conciseness, dictates markdown format, and enforces: _"Use the provided documentation sources to answer. If the answer isn't in the sources, say you don't know."_
2. **Scraped Context**:
...
3. **Memories**: Adds a small block of user preferences derived from past chats retrieved via Mem0 (e.g., _"User prefers Python example codes"_).
