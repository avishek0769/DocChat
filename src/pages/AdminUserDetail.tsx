                ...
                <div className="max-w-6xl mx-auto space-y-8">
                    <header>
                        ...
                        <p className="text-gray-400 text-sm">
                            Profile, activity, chats, and token usage.
                        </p>
                    </header>
                    {error && (
                    ...
                    <section className="p-6 rounded-xl bg-white/2 border border-white/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p>{formatTokens(user?.totalTokens || 0)}</p>
                            </div>
                        </div>
                    </section>
                    <section className="p-6 rounded-xl bg-white/2 border border-white/5">
                        ...
                        <div className="space-y-2">
                            {(data?.recentChats || []).map((chat) => (
                                <div
                                    key={chat.id}
                                    className="flex justify-between rounded-lg border border-white/5 bg-white/2 px-4 py-3"
                                >
                                    <span>{chat.name}</span>
