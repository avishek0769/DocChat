            ...
            <main className="flex-1 p-8 lg:p-12 overflow-y-auto w-full">
                <div className="max-w-6xl mx-auto space-y-8">
                    <header className="flex items-end justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-2">Ingestion</h1>
                            <p className="text-gray-400 text-sm">Ingestion health and failures.</p>
                        </div>
                    ...
                    <section className="p-6 rounded-xl bg-white/2 border border-white/5">
                        <h2 className="text-lg font-semibold mb-4">Failed Runs</h2>
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm">
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {(data?.recentFailedIngestionRuns || []).map((run) => (
                                        <tr key={run.id}>
                                            <td className="py-3">{run.chatId || run.id}</td>
                                            <td className="py-3 text-gray-400">{run.status}</td>
